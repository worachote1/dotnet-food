        ...
        <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <textarea type="text" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-300" placeholder="Enter your address"></textarea>
            </div>
            <div>
